...
\begin{figure}[htp]
  \centering
  \includegraphics[width=12cm]{unit-3/figures/03.png}
  \caption*{System Bus}
\end{figure}
\subsubsection{Central Processing Unit (CPU)}

The central processing unit (CPU) consists of a \textbf{control unit}, \textbf{ALU} and \textbf{registers}.
...
\begin{itemize}
  ...
  \item the address register (Either stores the memory address from which data will be fetched, or the address to which data will be sent and stored.)
...
\begin{figure}[htp]
  \centering
  \includegraphics[width=12cm]{unit-3/figures/01.png}
  \caption*{System Bus}
\end{figure}
...
\begin{figure}[htp]
  \centering
  \includegraphics[width=12cm]{unit-3/figures/04.png}
  \caption*{System Bus}
\end{figure}
...
Programs are composed of complex combinations of simple “instructions”.
...
Assembly language is a human-readable alternative form of machine language that uses letters and normal numbers so people can understand it.
Computer scans assembly code.As it encounters words it looks them up in a table to convert to binary.
Converts numbers to binary, then assembles (puts together) the binary pieces into an instruction.
...
\begin{figure}[htp]
  \centering
  \includegraphics[width=12cm]{unit-3/figures/05.png}
  \caption*{System Bus}
\end{figure}

MIPS is a RISC (Reduced Instruction Set Computer) architecture.
In MIPS, there are only 32 registers.
...
\begin{description}
  \item[I-type] Immediate: requires one or two registers and an operand.
  \item[R-type] Register: requires three registers.
  \item[J-type] Jump: requires an operand.
\end{description}

Commonly used variables kept in registers.
Then use a combination of registers and memory to access a large amount of data quickly.
