...
\begin{table}[htp]
  ...
  \begin{tabular}{rrl}
    ...
    \midrule
       ...
       14 & Concurrency and Synchronisation \\[1ex]
       15 & Deadlocks \\
       ...
       19 & Network Layer \\
       20 & Network Security \\
       21 & \sout{The JVM and Java Bytecode} \\
    \bottomrule
  \end{tabular}
\end{table}
\vspace*{\fill}
...
\chapter[Computer Architecture and OS Structures]{Computer Architecture and Operating System Structures}
...
\chapter{Quiz and Practice}
\section{Exercise-1}
\input{unit-22/notes-1.tex}
\section{Exercise-2}
\input{unit-22/notes-2.tex}
\section{Exercise-3}
\input{unit-22/notes-3.tex}
\section{Exercise-4}
\input{unit-22/notes-4.tex}
\section{Exercise-5}
\input{unit-22/notes-5.tex}
\section{Exercise-6}
\input{unit-22/notes-6.tex}
\section{Exercise-7}
\input{unit-22/notes-7.tex}
\section{Exercise-8}
\input{unit-22/notes-8.tex}
\section{Exercise-9}
\input{unit-22/notes-9.tex}
\section{Practice}
\input{unit-22/practice.tex}
\section{Quiz-1}
\input{unit-22/quiz-1.tex}
\section{Quiz-2}
\input{unit-22/quiz-2.tex}
\section{Quiz-3}
\input{unit-22/quiz-3.tex}
\section{Past Paper 2023}
\input{unit-22/past2023.tex}
\section{Past Paper 2024}
\input{unit-22/past2024.tex}
\pagebreak
\chapter{Appendix}
\section[The JVM and Java Bytecode]{The Java Virtual Machine and Java Bytecode}
\input{unit-21/notes.tex}
\section{Deadlocks}
