...
\section*{Q\#7}
Convert the following decimal real numbers into fixed point representation (using 8 bits). Convert the fixed point back to decimal real numbers. Do you get the same value as the original?
...
\section*{Q\#8}
Convert the following numbers into IEEE 754 (32-bit) floating point format with 8-bit exponent:
\begin{center}
\begin{tabular}{|>{\centering\arraybackslash}m{4cm}|>{\arraybackslash}m{10.5cm}|}
\hline
...
\begin{tabular}{|c|c|c|}
\hline
1 & 01110110 & 10110000001000011010000 \\
\hline
\end{tabular}
\\
\hline
