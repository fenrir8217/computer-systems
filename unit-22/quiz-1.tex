...
\begin{longtable}{|>{\raggedright}p{2cm}|p{11cm}|}
\hline
\textbf{Variation} & \textbf{Question} \\
\hline
7.2 & Consider the following MIPS assembly code:
...
Same structure, but initialised differently.

\textbf{Answer:} $-64$

\textbf{Solution \& Feedback:}\\
Multiplying with negative numbers leads to negative results through iteration.
...
\textbf{Variation} & \textbf{Question} \\
\hline
7.3 & Consider the following MIPS assembly code:
...
\textbf{Variation} & \textbf{Question} \\
\hline
8.1 & Evaluate the following RPN expressions using a stack and indicate the correct answer:
...
\textbf{Solution \& Feedback:}\\
First add 4+6=10, then 10*2=20, then 20+5=25, then 25+3=28.

(Note: Depending on original solution steps, confirm.)
...
\hline
\textbf{Variation} & \textbf{Question} \\ \hline
8.2 & Evaluate the following RPN expressions using a stack and indicate the correct answer:

9 3 + 8 2 * 7 - +

\textbf{Note:} All the values in the expression above are single digit numbers. \\ \hline
\textbf{Correct Answer(s)} & \textbf{Incorrect Answers} \\
21 & -40 \\
   & -4 \\
   & 28 \\
   & 46 \\ \hline
\multicolumn{2}{|l|}{\textbf{Solution \& Feedback:}} \\ \hline
\multicolumn{2}{|l|}{
...
\hline
\textbf{Variation} & \textbf{Question} \\ \hline
8.3 & Evaluate the following RPN expressions using a stack and indicate the correct answer:
...
\noindent
\subsection{\textbf{Variation} \textbf{Question} 10.1 }
\hspace{2cm} Consider the following MIPS assembly code:
\begin{lstlisting}
    lw $t1, &a
    lw $t2, &b
    mul $t3, $t1, $t2
...
\vspace{0.2cm}
\noindent
\textbf{Correct Answer(s)} \hspace{4cm} \textbf{Incorrect Answers} \\
75 \hspace{5.4cm} 45 \\
\hspace{5.4cm} 48 \\
\hspace{5.4cm} 135 \\
\hspace{5.4cm} 375 \\
...
\subsection{\textbf{Variation} \textbf{Question} 10.2}
\hspace{2cm} Consider the following MIPS assembly code:
\begin{verbatim}
    lw $t1, &a
    lw $t2, &b
...
\noindent Assuming initial values of $a=9$ and $b=15$, what will be the value of $c$ when the code completes its execution?

\vspace{0.5em}

\noindent\textbf{Correct Answer(s)}: 45 \\
