\textbf{Topics 2 \& 3: CPU, Memory, Program Execution \& MIPS Assembly – Exercise Sheet [Solutions]}

\subsection{Q\#1: Considering the simpler view of instructions, write the machine instructions representing each of the codes below:}
...
\subsection{Q\#2: Consider the below state of memory, where some values are already stored in different locations:}
\begin{center}
...
\begin{tabular}{|c|c|c|c|c|c|c|c|c|}
\hline
\textbf{Value} & 50 & \textcolor{red}{98} & 70 & 64 & 37 & 7 & 44 & \textcolor{red}{14} \\
\hline
\textbf{Address} & 2024 & 2028 & 2032 & 2036 & 2040 & 2044 & 2048 & 2052 \\
\hline
\end{tabular}
...
\begin{figure}
  \centering
  \includegraphics[width=15cm]{unit-22/figures/03.png}
\end{figure}
\newline
...
Write MIPS assembly code for the following expression.
\textbf{Expression:}  
\[
...
\subsection*{Q\#7: Given the MIPS Instruction set, convert the following MIPS assembly code into
...
\url{https://jarrettbillingsley.github.io/teaching/classes/cs0447/guides/instructions.html}
...
\subsection*{Q\#8: Consider the following MIPS assembly instructions}
\begin{itemize}
  \item{(a)} divu \$s7, \$s4, \$s5
  \item{(b)} srlv \$t3, \$t9, \$t7
  \item{(c)} sra \$t2, \$t4, 5
  \item{(d)} lw \$t5, 0x10(\$t4)
\end{itemize}
...
\begin{itemize}
    \item \url{https://jarrettbillingsley.github.io/teaching/classes/cs0447/guides/instructions.html}
    \item \url{http://alumni.cs.ucr.edu/~vladimir/cs161/mips.html}
\end{itemize}
\textbf{(a)} divu \$s7, \$s4, \$s5 \\
