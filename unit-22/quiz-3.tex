...
\begin{tabular}{|p{6cm}|p{6cm}|}
    ...
    \textbf{Correct Answer(s)} & \textbf{Incorrect Answers} \\
    \hline
    ...a particular application process, and the host machine running it, on the network. [cite: 145] & ...a particular host machine on the network. [cite: 145] \\
        & ...a particular application process on the network. [cite: 145] \\
        & ...a particular host machine and a user on the network. [cite: 145] \\
    \hline
\end{tabular}

\textbf{Solution \& Feedback:}

Socket address are made up of IP addresses (which uniquely identify a particular host machine on the network) and port numbers (which uniquely identify a particular application process running on a given host machine on the network). [cite: 146] When combined, they uniquely identify a particular application process, and the host machine running it, on the network. [cite: 147]
...
\begin{tabularx}{\textwidth}{|X|X|}
    ...
    \textbf{Correct Answer(s)} & \textbf{Incorrect Answers} \\
    \hline
    The protocol establishes a logical connection between the host and the server. [cite: 148] & The protocol is a best-effort service. [cite: 148] \\
    The protocol provides flow and congestion controls. [cite: 148] & The protocol's header is 8 bytes. [cite: 148] \\
    \hline
\end{tabularx}

\subsubsection{Variation 3.2}
...
\begin{tabularx}{\textwidth}{|X|X|}
    ...
    \textbf{Correct Answer(s)} & \textbf{Incorrect Answers} \\
    \hline
    The protocol utilises sequence and acknowledgement numbers. [cite: 149] & The protocol is connectionless. [cite: 149] \\
    The protocol provides flow and congestion controls. [cite: 149] & The protocol's header is 8 bytes. [cite: 149] \\
    \hline
\end{tabularx}

\subsubsection{Variation 3.3}
...
\begin{tabularx}{\textwidth}{|X|X|}
    ...
    \textbf{Correct Answer(s)} & \textbf{Incorrect Answers} \\
    \hline
    The protocol is connectionless. [cite: 150] & The protocol utilises sequence and acknowledgement numbers. [cite: 150] \\
    The protocol's header is 8 bytes. [cite: 150] & The protocol establishes a logical connection between the host and the server. [cite: 150] \\
    \hline
\end{tabularx}

\textbf{Solution \& Feedback:}

HTTP/1.1 and SMPT use the TCP Transport Layer protocol. [cite: 151] TCP in a connection-oriented protocol which provides a variety of transport services, such as flow and congestion controls and the utilizations of sequence and acknowledgement numbers to support reliable data transfer. [cite: 152]
Meanwhile, DNS uses UDP, which is a best-effort, connectionless Transport Layer protocol which has fewer transport services and, thus, a more lightweight header (only 8 bytes). [cite: 153]

\subsubsection{\textcolor{red}{Variation 4.1}}
...
\begin{tabularx}{\textwidth}{|X|X|}
    ...
    \textbf{Correct Answer(s)} & \textbf{Incorrect Answers} \\
    \hline
    23488.10 sec [cite: 154] & 2936.01 sec [cite: 154] \\
        & 3914.68 sec [cite: 154] \\
        & 489.33 sec [cite: 154] \\
    \hline
\end{tabularx}
...
File size (in KiB) \(=1400*1024=1433600~KiB\) [cite: 154]
File size (in Bytes) \(=1433600*1024=1468006400~Bytes\) [cite: 154]
File size (in Bits) = \(1468006400*8=11744051200~Bit\) [cite: 154]
File transfer time will be \(e=11744051200/(500*1000)=23488.10~seconds.\) [cite: 154]
...
\begin{tabular}{|p{6cm}|p{6cm}|}
    ...
    \textbf{Correct Answer(s)} & \textbf{Incorrect Answers} \\
    \hline
    20971.52 sec [cite: 155] & 2621.44 sec [cite: 155] \\
        & 2516.58 sec [cite: 155] \\
        & 314.57 sec [cite: 155] \\
    \hline
\end{tabular}

\textbf{Solution \& Feedback:}
Effective throughput on this network will be 600 Kbps (the lowest rate). [cite: 156]
File size (in KiB) \(=1500*1024=1536000~KiB\)  [cite: 157]
File size (in Bytes) \(=1536000*1024=1572864000~B\) Bytes [cite: 157]
File size (in Bits) = \(1572864000*8=12582912000~Bit\)  [cite: 157]
File transfer time will \(le=12582912000/(600*1000)=20971.52~seconds.\) [cite: 157]

\subsubsection{Variation 4.3}
...
\begin{tabular}{|p{6cm}|p{6cm}|}
    ...
    \textbf{Correct Answer(s)} & \textbf{Incorrect Answers} \\
    \hline
    20372.33 sec [cite: 158] & 2546.54 sec (forgot to convert filesize to bits) [cite: 158] \\
        & 4753.54 sec (uses highest rate) [cite: 158] \\
        & 594.19 sec (uses highest rate \& incorrect filesize) [cite: 158] \\
    \hline
\end{tabular}

\subsubsection{Variation 5.1}
\begin{tabular}{|p{6cm}|p{6cm}|}
    \hline
...
Using Longest Prefix Matching, deduce which output port of Router X a packet with IP destination 167.53.11.90 will be transferred to. \\
    ...
    \hline
    1 & 10100111.00110101.001100... \\
    2 & 01110000.10101100.10... \\
    3 & 10100111.00110101.01... \\
    4 & 10100111.001100... \\
    5 & 10100111.00110101.0001... \\
    6 & otherwise \\
    \hline
    \textbf{Correct Answer(s)} & \textbf{Incorrect Answers} \\
    \hline
...
Using Longest Prefix Matching, deduce which output port of Router X a packet with IP destination 85.209.126.1 will be transferred to. \\
    ...
    \textbf{Output Port} & \textbf{Destination IP Address Range} \\
    \hline
    1 & 01010101.11010001.01110... \\
    2 & 01010101.11010001.0111100... \\
    3 & 1011... \\
    4 & 01010101.11010001.01011001... \\
    5 & 01010101.1101001... \\
    6 & otherwise \\
    \hline
    \textbf{Correct Answer(s)} & \textbf{Incorrect Answers} \\
...
\subsubsection{Variation Question 8.1}
...
(due to the Great Firewall), which remain unaffected. [cite: 63, 64] Fortunately, the 
virus only impacts Root DNS servers, leaving Top-Level Domain (TLD) 
DNS servers and Authoritative Domain servers unharmed. [cite: 64] Students at the 
University of Birmingham wish to resolve the DNS query for Amazon's 
website. [cite: 65, 66, 67, 68, 69] The following data is provided:
...
regardless of which server, in any country, is being contacted. [cite: 66, 67, 68, 69] Additionally, the first Root DNS server query always targets the 
geographically closest server. [cite: 67, 68, 69] If this query fails, it randomly selects 
another Root DNS server, which hasn’t been tried before. [cite: 67, 68, 69] What is the shortest and the longest possible time for a Local DNS server 
...
\subsubsection{Variation Question 8.3}
...
University of Birmingham wish to resolve the DNS query for Amazon's 
website. [cite: 85, 86, 87, 88, 89, 90, 91, 92, 93, 94, 95] The following data is provided:
...
\subsubsection{Variation Question 9.1}
...
NOT(1100001101010001)
 = 0011110010101110
\subsubsection{Variation Question 9.2}
...
NOT(0101000101101010)
 = 1010111010010101
\subsubsection{Variation Question 9.3}
...
its messages as four nibbles (i.e. two bytes). [cite: 104, 105] Its associated Transport 
Layer protocol is UDP. [cite: 105] Following the method we discussed in the lecture, 
compute the checksum of the following 4NMP message’s associated 
UDP segment:
10101010 
11100101
\textbf{Correct Answer(s) Incorrect Answers}
0001010101000101 1110101010111010
0001010101011001
1110101010100110
\textbf{Solution \& Feedback:}
Step 1. Split the UDP segment into 16-bit chunks. [cite: 105, 106]
Source port 
= (32311)10
= 0111111000110111
Destination port
...
+ 1010101011101111
= 1110101010111010
Step 3. NOT the result to compute the checksum. [cite: 106, 107, 108]
NOT(1110101010111010)
 = 0001010101000101

\subsubsection{Variation Question 10.1}

A company has 428 hosts on its network. [cite: 109, 110] The IP address of one host 
machine on this subnet is 167.53.11.90. [cite: 110, 111] Assuming the subnet has been 
...
host part of minimum 9 bits (log2(428) = 8.74…). [cite: 111, 112, 113]
The IP address 167.53.11.90 in binary is 10100111.00110101.00001011.01011010.
[cite: 113] Given the host part is 9 bits, the first address owned by the subnet will be 
10100111.00110101.00001010.00000000 and the last address will be 
10100111.00110101.00001011.11111111 (the underlining delineating the subnet parts 
of the address). [cite: 113, 114]
Converting this back to denary, the range is 167.53.10.0 - 167.53.11.255. [cite: 114]
\subsubsection{Variation Question 10.2}

A company has 875 hosts on its network. [cite: 115, 116, 117] The IP address of one host 
machine on this subnet is 85.209.126.1. [cite: 116, 117] Assuming the subnet has been 
designed to minimise the number of redundant addresses, what is the 
range of IP addresses in this subnet (including the network and broadcast 
addresses)?
\textbf{Correct Answer(s)}
...
host part of minimum 10 bits (log2(875) = 9.77…). [cite: 117, 118, 119]
The IP address 85.209.126.1 in binary is 01010101.11010001.01111110.00000001. [cite: 119]
...
of the address). [cite: 119, 120]
Converting this back to denary, the range is 85.209.124.0 - 85.209.127.255. [cite: 120]

\subsubsection{Variation Question 10.3}

A company has 1100 hosts on its network. [cite: 121, 122, 123] The IP address of one host 
machine on this subnet is 1.88.5.200. [cite: 122, 123] Assuming the subnet has been 
designed to minimise the number of redundant addresses, what is the 
range of IP addresses in this subnet (including the network and broadcast 
addresses)?
\textbf{Correct Answer(s)}
...
host part of minimum 11 bits (log2(1100) = 10.103…). [cite: 123, 124, 125]
The IP address 1.88.5.200 in binary is 00000001.01011000.00000101.11001000. [cite: 125]
...
of the address). [cite: 125, 126]
Converting this back to denary, the range is 1.88.0.0 - 1.88.7.255. [cite: 126]