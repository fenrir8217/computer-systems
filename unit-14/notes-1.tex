...
To do so, \textcolor{red}{it must preserve the state of each process so that its execution may resume.}
...
\begin{figure}[htp]
  \centering
  \includegraphics[width=12cm]{unit-14/figures/01.png}
  \caption*{Synchronization of Processes}
\end{figure}
...
\textcolor{red}{This is achieved through strict serialisation, or mutual exclusion,} causing the critical sections to behave as atomic operations.
...
\textbf{Requirements for Solutions to the Problem}
...
\begin{enumerate}
  ...
  \end{itemize}
\end{enumerate}
\textbf{Solutions to the Critical Section Problem}
\begin{enumerate}
...
\begin{figure}[htp]
  \centering
  \includegraphics[width=12cm]{unit-14/figures/02.png}
  \caption*{Shared Lock Problem}
\end{figure}
...
\textcolor{blue}{Spin locks are used at kernel level (special HW instructions).}
\subsubsection{Busy-Waiting (Strict Alternation)}
\begin{figure}[htp]
  \centering
  \includegraphics[width=12cm]{unit-14/figures/03.png}
